        <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
                ...
                <div class="col-md-12">
                <form class="form-horizontal" action="${pageContext.request.contextPath}/equipment/list.do"
                method="post">
                ...
                onclick="javascript:window.location.href=''">添 加</button>
                </div>
                -->
                </div>
                <div class="form-group">
                ...
                <div class="col-sm-9">
                <input type="text" class="form-control" id="typename" name="name" style="width: 250px" maxlength="15"
                placeholder="10个汉字以内" />
                ...
                <div class="col-sm-9">
                <input type="text" class=" sortNumber form-control" name="sortNumber" id="sortNumber" style="width:
                250px"
                maxlength="3"/>
                </div>
                </div>
